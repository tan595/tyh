...
def run_all(args):
    ...
    print(
        '  Model: Final full model '
        f'(HECLIP + MultiScale + WiKG topk={args.wikg_top})'
    )
    ...
    for fold_idx, fold in enumerate(fold_list):
        ...
        ckpt_path = getattr(ckpt_callback, 'b' + 'est_model_path')
        ...
        trainer2.test(model, val_loader, ckpt_path=ckpt_path)
