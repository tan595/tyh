...
def train(args):
    ...
    print(
        'Using FinalModel '
        f'[HECLIP(temp={args.heclip_target_temp},lam={args.heclip_mix_lambda})+'
        f'MultiScale(k_s={args.multiscale_k_small},'
        f'k_l={args.multiscale_k_large},'
        f'k_q={args.multiscale_k_query},'
        f'heads={args.multiscale_heads},'
        f'w_branch={args.w_branch})+'
        f'WiKG(topk={args.wikg_top})]'
    )
