...
def parser_option():
    ...
    parser.add_argument('--w_fusion', type=float, default=0.2,
                        help='weight for fusion distillation loss (multi-res only)')

    # model choice
    parser.add_argument('--model', type=str, default='reg2st',
                        choices=['reg2st', 'final'], help='model to use')

    # ablation flags
    parser.add_argument('--use_multires', action='store_true', default=False,
                        help='enable multi-resolution (NeighborEncoder + GlobalEncoder)')
    parser.add_argument('--use_heclip', action='store_true', default=False,
                        help='enable HECLIP mix contrastive loss')
    ...
    parser.add_argument('--neighbor_k', type=int, default=6,
                        help='number of spatial neighbors for NeighborEncoder')
